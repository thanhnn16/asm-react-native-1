...
import { getUser, updateUser } from "../../../api/services/userService.ts";
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        <InputWithIcon icon={require("../../../assets/images/icons/input_field_icons/profile.png")}
                       placeholder={"Họ và tên"}
                       value={name}
                       setValue={setName} editable={isEditing} />

        <InputWithIcon icon={require("../../../assets/images/icons/input_field_icons/sms.png")}
                        placeholder={"Email"}
                        value={email}
                        setValue={setEmail} editable={isEditing} />

        <InputWithIcon icon={require("../../../assets/images/icons/input_field_icons/map.png")}
                        placeholder={"Địa chỉ"}
                        value={address}
                        setValue={setAddress} editable={isEditing} />

        <Pressable onPress={()=> {
          setOpen(true);
          console.log("Date of birth");
        }}>
        <InputWithIcon icon={require("../../../assets/images/icons/input_field_icons/calendar-2.png")}
                        placeholder={"Ngày sinh"}
                        value={dob}
                        setValue={setDob} editable={false} />
        </Pressable>
        <Pressable onPress={()=> {
        ...
        <InputWithIcon icon={require("../../../assets/images/icons/input_field_icons/aquarius.png")}
                        placeholder={"Giới tính"}
                       value={gender === 'male' ? 'Nam' : gender === 'female' ? 'Nữ' : 'Khác'}
                       setValue={setGender} editable={false} />
        </Pressable>
        <Pressable
          style={styles.button}
          onPress={() => {
